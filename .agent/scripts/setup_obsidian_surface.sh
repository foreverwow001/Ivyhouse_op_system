...
Examples:
  bash .agent/scripts/setup_obsidian_surface.sh --vault-root ~/ObsidianVault
  bash .agent/scripts/setup_obsidian_surface.sh --vault-root /shared/ObsidianVault --mode copy
EOF
}
