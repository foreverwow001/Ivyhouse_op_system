...
description: "僅限 workflow template 使用的工具，用於把 reviewed-sync candidate 寫入 Obsidian，並在核准後透過 frontmatter 正規化、index 更新與 dedupe 升格到 20-reviewed。"
---
...
- entry doc: `.github/workflow-core/skills/reviewed-sync-manager/SKILL.md`
- canonical script: `.github/workflow-core/skills/reviewed-sync-manager/scripts/reviewed_sync_manager.py`
...
```bash
python .github/workflow-core/skills/reviewed-sync-manager/scripts/reviewed_sync_manager.py promote-candidate \
  --vault-root /obsidian/vault \
