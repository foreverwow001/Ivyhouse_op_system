...
if [[ -f .github/workflow-core/runtime/scripts/install_workflow_prereqs.sh ]]; then
  bash .github/workflow-core/runtime/scripts/install_workflow_prereqs.sh || true
fi
...
if [[ -f .github/workflow-core/runtime/scripts/vscode/install_terminal_tooling.sh ]]; then
  bash .github/workflow-core/runtime/scripts/vscode/install_terminal_tooling.sh || true
elif [[ -f .github/workflow-core/runtime/scripts/vscode/install_terminal_orchestrator.sh ]]; then
  bash .github/workflow-core/runtime/scripts/vscode/install_terminal_orchestrator.sh || true
fi
