...
它不取代 `.github/workflow-core/roles/security.md`；它是在 Security Reviewer 角色之上，加上一層「是否要記錄到 pending-review-notes」的判斷與執行規格。

## 使用前先讀

1. `.github/workflow-core/roles/security.md`
2. `.github/workflow-core/skills/pending-review-recorder/SKILL.md`
3. `.github/workflow-core/skills/security-review-helper/SKILL.md`
4. template repo 維護：`.github/workflow-core/workflow_baseline_rules.md`
